# Quadro de Análise de Arquivos

Este quadro Kanban rastreia o status da análise de cada arquivo individualmente.
...
_Nenhum item em análise no momento._
...
- [x] `controle_pragas_integrado.md`
- [x] `Itens de Higiene Recomendados para Restaurantes_ Sanitizantes, EPIs e Acessórios.md`
- [x] `impactos_biodigestores.md`
- [x] `Dores - Hierarquia para os diversos setores.md`
- [x] `FLUXOGRAMA BUSCA POR PRODUTOS.md`
- [x] `Discussão Produtos de limpeza.md`
- [x] `LIMPEZA E GESTORES- DADOS.md`
